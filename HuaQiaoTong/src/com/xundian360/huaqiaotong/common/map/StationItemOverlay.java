...
public class StationItemOverlay extends ItemizedOverlay {
	...
	public StationItemOverlay(Context context, Drawable arg0, MapView arg1, List<Station> objects) {
		super(arg0, arg1);
	...
	public boolean onTap(int index){
		...
		// 覆层View
		CommonOverlayView overlayView = new CommonOverlayView(context, stationItem);
		// 底部弹出的Dialog
