...
public class SimpleLocationManager {
	...
	/**
	 * 定位管理器
	 * @param 							    app 主线程Application
	 * @param locationListener	位置管理器回调
	 */
	public SimpleLocationManager(Application app, BDLocationListener locationListener) {
	 ...
	 * @param 							    app 主线程Application
	 * @param locationListener	位置管理器回调
	 * @param scanSpan              定位时间间隔
	 */
	public SimpleLocationManager(Application app, BDLocationListener locationListener, int scanSpan) {
