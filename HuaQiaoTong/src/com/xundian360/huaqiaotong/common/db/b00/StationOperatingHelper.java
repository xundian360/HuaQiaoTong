...
public class StationOperatingHelper extends BusStationOperatingHelper {
	...
	public List<Station> getStationByStationId(String[] ids) {
		...
		// 取得查找Cursor
//		Cursor cursor = selectRecode(TABLE_BUS_STATION, null, "busStopId" + " in ?",
...
//		close();
	...
	public List<Station> getStations() {
		...
		// 取得查找Cursor
		Cursor cursor = selectRecode(TABLE_BUS_STATION, null, null,
				null, null, null, null);
	...
	public List<Station> getStationsNotInList(List<Station> stations) {
		...
		// 查询数据库
		// 取得查找Cursor
		Cursor cursor = selectRecode(TABLE_BUS_STATION, null, sql_condition.toString(),
				null, null, null, null);
	...
	public List<Station> getBusStation(Context context, Bus bus) {
		...
		// 取得对应的站点信息
		List<Station> stations = getStationByStationId((String[])stopIds.toArray(new String[stopIds.size()]));
