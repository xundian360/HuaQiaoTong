...
public class CopyOfMainActivity extends Activity {
	...
	OnClickListener logotBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			UserModle userModle = new UserModle(CopyOfMainActivity.this);
	...
	OnClickListener toBusBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			// 公交首页迁移
			CommonUtil.startSubActivity(CopyOfMainActivity.this, B00V00Activity.class);
		}
	};
...
//			CommonUtil.startSubActivity(MainActivity.this, B01V00Activity.class);
			...
			Intent intent = new Intent(CopyOfMainActivity.this, B01V00Activity.class);
			intent.putExtra(B01V00Activity.ITEM_OBJECT_KEY, ktvItem);
			
			CommonUtil.startSubActivity(CopyOfMainActivity.this, intent);
		}
	};
...
// 			
	...
	OnClickListener taxiBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			// 公交首页迁移
			CommonUtil.startSubActivity(CopyOfMainActivity.this, B02V00Activity.class);
		}
	};
	...
	OnClickListener bickBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			// 自行车
			CommonUtil.startSubActivity(CopyOfMainActivity.this, B02V02Activity.class);
		}
	};
	...
	OnClickListener forumBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			// 论坛
			CommonUtil.startSubActivity(CopyOfMainActivity.this, B03V00Activity.class);
		}
	};
	...
	OnClickListener loginBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			// 判断用户是否登录
			if(UserUtils.isLogin(CopyOfMainActivity.this)) {
				// 登陆
				CommonUtil.startSubActivity(CopyOfMainActivity.this, B04V03Activity.class);
			} else {
				// 登陆
				CommonUtil.startSubActivity(CopyOfMainActivity.this, B04V00Activity.class);
			} 
		}
	};
	...
	OnClickListener locationBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			// 周边信息
			CommonUtil.startSubActivity(CopyOfMainActivity.this, B05V00Activity.class);
		}
	};
	...
	OnClickListener mainBtnClick  = new OnClickListener() {
		...
		public void onClick(View arg0) {
			// 周边信息
			CommonUtil.startSubActivity(CopyOfMainActivity.this, B00Activity.class);
		}
	};
