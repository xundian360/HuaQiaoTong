...
public class CopyOfMainActivity extends Activity {
	...
	OnClickListener toBusBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			// 公交首页迁移
			CommonUtil.startSubActivity(CopyOfMainActivity.this,
					B00V00Activity.class);
		}
	};
	...
	OnClickListener jianBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			// 设置宾馆项目
			ItemObject hotelItem = new ItemObject(ItemConstants.JIAN_TEXT_ID,
					ItemConstants.JIAN_KEY_ID, ItemConstants.ITEM_NAV_NULL,
					null, null, null);
