 ...
 * @date 2013年10月28日
 * @version 1.0
 * @disc 论坛帖子一览 { "status": 0, "total": 206, "results": [ { "tittle": "花桥地铁开通了",
 *       "tDtail": "花桥地铁开通了花桥地铁开通了花桥地铁开通了花桥地铁开通了花桥地铁开通了", "commentN": "152",
 *       "author": "鬼太郎", "img":
 *       "http://developer.baidu.com/map/static/img/developer980-370.jpg",
 *       "uid": "befdb292767279f887154123" }, { "tittle": "花桥地铁开通了", "tDtail":
 *       "花桥地铁开通了花桥地铁开通了花桥地铁开通了花桥地铁开通了花桥地铁开通了", "commentN": "152", "author":
 *       "鬼太郎", "img":
 *       "http://developer.baidu.com/map/static/img/developer980-370.jpg",
 *       "uid": "befdb292767279f887154123" } ] }
 * 
 *       帖子明细 { "status": 0, "tittle": "花桥地铁开通了", "commentN": "152", "author":
 *       "鬼太郎", "uid": "befdb292767279f887154123" "dtailL": [ { "type": "txt",
 *       "msg": "花桥地铁开通了花桥地铁开通了花桥地铁开通了花桥地铁开通了花桥地铁开通了" }, { "type": "img", "msg":
 *       "http://developer.baidu.com/map/static/img/developer980-370.jpg" } ] }
 * 
 */
public class B03v00Util extends BaiduUtil {
	 ...
	 */
	public static List<PostsItem> getPostsDetailData(Context context,
			String themeId) throws JSONException {

		String url = context.getString(R.string.get_theme_details);
	...
	private static List<PostsItem> getPostsItemListFromJson(String jsonString)
			throws JSONException {
	...
	public static Map<String, Object> getPostsDataFromJson(String jsonString) {
		...
		try {
			...
			if (STATUS_OK_KEY.equals(postsListJson.getString("status"))) {
				...
				// 设置帖子
				postses.put(RESULTS_KEY, getPostsListFromJson(postsListJson
	 ...
	 * @throws JSONException
	 */
	private static List<Posts> getPostsListFromJson(JSONArray jsonArray)
			throws JSONException {
	 ...
	 */
	@SuppressWarnings("finally")
	public static String sendPosts(Context context, String userId,
			String groupId, String themeTitle, String themeMessage,
			RequestCallBack<String> callBack, List<String> fileKeys,
		...
		try {
			...
			// 上传数据
			BaseHttpClient.doPostRequestWithFile(url, params, fileKeys,
					filePaths, callBack);
	...
	public static final int[] GROUP_KEYS = { R.string.b03v00_btn_item_key_0,
			R.string.b03v00_btn_item_key_1, R.string.b03v00_btn_item_key_2,
			R.string.b03v00_btn_item_key_3, R.string.b03v00_btn_item_key_4,
			R.string.b03v00_btn_item_key_5, R.string.b03v00_btn_item_key_6,
			R.string.b03v00_btn_item_key_7, R.string.b03v00_btn_item_key_8,
			R.string.b03v00_btn_item_key_9, R.string.b03v00_btn_item_key_10,
			R.string.b03v00_btn_item_key_11 };

	public static final int[] GROUP_NAMES = { R.string.b03v00_btn_item_0,
			R.string.b03v00_btn_item_1, R.string.b03v00_btn_item_2,
			R.string.b03v00_btn_item_3, R.string.b03v00_btn_item_4,
			R.string.b03v00_btn_item_5, R.string.b03v00_btn_item_6,
			R.string.b03v00_btn_item_7, R.string.b03v00_btn_item_8,
