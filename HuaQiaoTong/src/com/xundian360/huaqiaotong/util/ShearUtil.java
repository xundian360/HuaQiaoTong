...
public class ShearUtil {
	 ...
	 * @param paListener
	 */
	public static void shearToSinaWeibo(Context context, String text,
			String imagePath, PlatformActionListener paListener) {
	 ...
	 * @param paListener
	 */
	public static void shearToSinaWeiboWithURL(Context context, String text,
			String url, PlatformActionListener paListener) {
	 ...
	 * @param imagePath
	 */
	public static void shearPicToWxWithURL(Context context, String title,
			String msg, String url, PlatformActionListener paListener) {
	 ...
	 * @param imagePath
	 */
	public static void shearPicToWxFWithURL(Context context, String title,
			String msg, String url, PlatformActionListener paListener) {
