...
public class SimpleViewBuilder extends ViewBuilder<Posts> {
	...
	DisplayImageOptions options = new DisplayImageOptions.Builder()
			...
			.showImageOnFail(R.drawable.test_user_logo).cacheOnDisc(true)
			.build();
	...
	DisplayImageOptions options2 = new DisplayImageOptions.Builder()
			...
			.showImageOnFail(R.drawable.test_b03v04_img).cacheOnDisc(true)
			.build();
	...
	public void updateView(View view, int position, Posts data) {
		...
		ImageLoader.getInstance().displayImage(posts.getAuthorPic(), userLogo,
				options);
		...
		// 帖子图片
		ImageView postPicView = (ImageView) view
				.findViewById(R.id.b03v04ItemImg);
		ImageLoader.getInstance().displayImage(posts.getImg(), postPicView,
				options2);

		// 帖子Tittle
		TextView postTittle = (TextView) view
				.findViewById(R.id.b03v04ItemTittle);
		postTittle.setText(posts.getTittle());

		// 评论数
		TextView commentNum = (TextView) view
				.findViewById(R.id.b03v04ItemComNum);
