...
//				new ViewGroup.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
	...
	private void initView() {
		mainView = ((Activity)context).getLayoutInflater().inflate(R.layout.b02v02_bottom, null);
		
		bickName = (TextView) mainView.findViewById(R.id.b02v02BottomBickAddress);
		...
		lastNum = (TextView) mainView.findViewById(R.id.b02v02BottomBickLastNum);
		lastNum.setText(bickObj.getLastNum() + "");
		
		overlayToHere = (Button) mainView.findViewById(R.id.b02v02BottomPlanBtn);
