...
public class B02v00CarView {
	...
	public B02v00CarView(Context context, String tittle, List<Texi> taxis) {
	...
	private void initData() {
		...
		taxiAdapter = new B02V00TexiAdapter(context, data, 
				R.layout.b02v00_car_item, 
				B02V00TexiAdapter.from, 
				B02V00TexiAdapter.to, 
				taxis);
	...
	private void initView() {
		...
		mainView = LayoutInflater.from(context)
				.inflate(R.layout.b02v00_car_layout, null);
	...
	OnClickListener cancelBtnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			// 取消车辆显示
			((B02V00Activity)context).canceCarList();
		}
	};
