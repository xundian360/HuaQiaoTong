...
import com.xundian360.huaqiaotong.adapter.com.ImageAdapter;
...
public class B00RightView implements OnClickListener {
	...
	// 数据源
	ImageAdapter tittleImgsAdapter;
	...
	private void initData(){
		...
		tittleImgsAdapter = new ImageAdapter(context, testPics);
	}
	...
	private void initView() {
		...
		tittleImgs = (Gallery) mainView.findViewById(R.id.b00RightImgs);
		tittleImgs.setAdapter(tittleImgsAdapter);
		...
		tittleImgStatus = (LinearLayout) mainView.findViewById(R.id.b00RightImgStatus);
	...
	public void onClick(View v) {
		...
		switch (clickId) {
			case R.id.b00RightXxBtn:
				// 设置参数
				selectPostGroup = new PostGroup(context.getString(R.string.b03v00_right_xx_key), 
			...
			case R.id.b00RightJyBtn:
				// 设置参数
				selectPostGroup = new PostGroup(context.getString(R.string.b03v00_right_jy_key), 
			...
			case R.id.b00RightFwBtn:
				// 设置参数
				selectPostGroup = new PostGroup(context.getString(R.string.b03v00_right_fw_key), 
			...
			case R.id.b00RightYhBtn:
				// 设置参数
				selectPostGroup = new PostGroup(context.getString(R.string.b03v00_right_yh_key), 
			...
			case R.id.b00RightQzBtn:
				// 设置参数
				selectPostGroup = new PostGroup(context.getString(R.string.b03v00_right_qz_key), 
			...
			case R.id.b00RightEsBtn:
				// 设置参数
				selectPostGroup = new PostGroup(context.getString(R.string.b03v00_right_es_key), 
