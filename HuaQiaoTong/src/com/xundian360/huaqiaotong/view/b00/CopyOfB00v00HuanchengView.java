...
public class CopyOfB00v00HuanchengView {
	...
	// public CopyOfB00v00HuanchengView(Context context, boolean
	// showLocationSelect) {
	//
	// this.context = context;
	...
	//
	// mainView =
	// ((Activity)context).getLayoutInflater().inflate(R.layout.b00v00_huancheng,
	// null);
	//
	...
	//
	// toFromLocation = (ImageButton)
	// mainView.findViewById(R.id.b00v00ToFromLocation);
	// toFromLocation.setOnClickListener(ToFromLocationClick);
	// toFromLocation.setVisibility(showLocationSelect ? View.VISIBLE :
	// View.GONE);
	//
	...
	//
	// toToLocation = (ImageButton)
	// mainView.findViewById(R.id.b00v00ToToLocation);
	// toToLocation.setOnClickListener(ToToLocationClick);
	// toToLocation.setVisibility(showLocationSelect ? View.VISIBLE :
	// View.GONE);
	//
	// huanchengSearch = (ImageButton)
	// mainView.findViewById(R.id.b00v00HuanchengSearch);
