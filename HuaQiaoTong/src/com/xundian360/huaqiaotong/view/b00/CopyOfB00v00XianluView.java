...
////				dataItem.put(B00v00XianluAdapter.from[1], bus.getDirection());
////				
//////				dataItem.put(B00v00XianluAdapter.from[2], R.drawable.b00v02_no_shuocang_btn);
////			
////				data.add(dataItem);
////				showBuses.add(bus);
////			}
...
//		
//		// 其他组件
//		xianluHistoryBtn = (ImageButton) mainView.findViewById(R.id.b00v00XianluHistoryBtn);
...
//		
//		xianluYuyingBtn = (ImageButton) mainView.findViewById(R.id.b00v00XianluYuyingBtn);
//		xianluYuyingBtn.setOnClickListener(xianluYuyingClick);
//		
//		xianluSearchBtn = (ImageButton) mainView.findViewById(R.id.b00v00XianluSearchBtn);
...
//				
//				// 重建Dialog
//				xianluSelectDialog = new B00SelectXianluHistoryDialog(context, call, shoucangBuses);
//				
//				// 显示Dialog
