...
//		
//		// 设置Adapter
////		zhandianAdapter = new SearchAdapter(context, data, R.layout.b00v00_zhandian_item, 
...
//		
//		// 其他组件
//		zhanDianHistoryBtn = (ImageButton) mainView.findViewById(R.id.b00v00ZhanDianHistoryBtn);
...
//		
//		zhanDianYuyingBtn = (ImageButton) mainView.findViewById(R.id.b00v00ZhanDianYuyingBtn);
//		zhanDianYuyingBtn.setOnClickListener(zhanDianYuyingClick);
//		
//		zhanDianSearchBtn = (ImageButton) mainView.findViewById(R.id.b00v00ZhanDianSearchBtn);
//		zhanDianSearchBtn.setOnClickListener(zhanDianSearchClick);
//		
////		zhandianList = (ListView) mainView.findViewById(R.id.b00v00ZhandianList);
...
//			
//			zhanDianInText = StringUtils.isBlank(zhanDianInText) ? null : zhanDianInText;
//			
...
//				
//				// 重建Dialog
//				zhandianSelectDialog = new B00SelectZhandianHistoryDialog(context, call, shoucangStations);
//				
//				// 显示Dialog
