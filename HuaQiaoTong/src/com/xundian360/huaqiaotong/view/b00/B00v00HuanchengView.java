...
public class B00v00HuanchengView {
	...
	private void initView() {
		...
		fromText = (AutoCompleteTextView) mainView.findViewById(R.id.b00v00FromText);
		...
		toText = (AutoCompleteTextView) mainView.findViewById(R.id.b00v00ToText);
...
//		String textString = "11111";
	...
	TextWatcher toTextWatcher = new TextWatcher() {
		...
		public void onTextChanged(CharSequence s, int start, int before, int count) {
			...
			else if(s.length() <= 0 && toInputDelete.getVisibility() == View.VISIBLE) {
	...
	TextWatcher fromTextWatcher = new TextWatcher() {
		...
		public void onTextChanged(CharSequence s, int start, int before, int count) {
			...
			else if(s.length() <= 0 && fromInputDelete.getVisibility() == View.VISIBLE) {
