...
public class B01v01DatailTittleView {
	...
	private void initView() {
		mainView = ((Activity) context).getLayoutInflater().inflate(
				R.layout.b01v01_detail_tittle, null);

		callCupViewLayout = (LinearLayout) mainView
				.findViewById(R.id.b01v01CallCup);

		callCupView = new LslideView(context, null, null, null,
				callSlideListener, "滑动拨打电话");
		...
		callCupViewLayout.addView(callCupView, new LayoutParams(
		...
		impressionGood = (TextView) mainView
				.findViewById(R.id.b01v01DetailImp1);
