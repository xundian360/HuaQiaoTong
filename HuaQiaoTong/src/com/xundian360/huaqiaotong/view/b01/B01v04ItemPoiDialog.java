...
public class B01v04ItemPoiDialog extends BottomDialog {
	...
	private void initView() {
		...
		mainView = LayoutInflater.from(context).inflate(R.layout.b01v04_bottom, null);
		
		poiTittle = (TextView) mainView.findViewById(R.id.b01v04PoiTittle);
		poiTittle.setText(bickObj.getName());
		
		poiDetailBtn = (LinearLayout) mainView.findViewById(R.id.b01v04PoiDetailBtn);
	...
	OnClickListener poiDetailBtnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			// 详情页面迁移
			CommonUtil.startActivityForResult(context, B01V01Activity.class, B01V01Activity.KTV_KEY, bickObj, 1000);
		}
	};
