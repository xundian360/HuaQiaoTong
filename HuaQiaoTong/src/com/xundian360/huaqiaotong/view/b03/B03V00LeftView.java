...
public class B03V00LeftView implements OnClickListener {
	...
	private void initView() {
		...
		firstImgTittle = (TextView) mainView
				.findViewById(R.id.b03v00G0Img6Tittle);
	...
	public void onClick(View v) {
		...
		case R.id.b03v00G0Item3Btn:
			CommonUtil.startActivityForResult(
					...
					new PostGroup(context
							.getString(R.string.b03v00_btn_item_key_2), context
							.getString(R.string.b03v00_btn_item_2)),
					REQUEST_CODE);
			break;
		case R.id.b03v00G0Item4Btn:
			CommonUtil.startActivityForResult(
					...
					B03V04Activity.POST_GROUP_KEY,
					new PostGroup(context
							.getString(R.string.b03v00_btn_item_key_3), context
							.getString(R.string.b03v00_btn_item_3)),
					REQUEST_CODE);
			break;
		case R.id.b03v00G0Item5Btn:
			CommonUtil.startActivityForResult(
					...
					B03V04Activity.POST_GROUP_KEY,
					new PostGroup(context
							.getString(R.string.b03v00_btn_item_key_4), context
							.getString(R.string.b03v00_btn_item_4)),
					REQUEST_CODE);
			break;
		case R.id.b03v00G0Item6Btn:
			CommonUtil.startActivityForResult(
					...
					B03V04Activity.POST_GROUP_KEY,
					new PostGroup(context
							.getString(R.string.b03v00_btn_item_key_5), context
							.getString(R.string.b03v00_btn_item_5)),
					REQUEST_CODE);
			break;
