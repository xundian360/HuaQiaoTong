...
public class B03V00RightView implements OnClickListener {
	...
	private void initView() {
		mainView = ((Activity)context).getLayoutInflater().inflate(R.layout.b03v00_detail_r, null);
		
		firstImg = (RelativeLayout) mainView.findViewById(R.id.b03v00G0Img7Btn);
		firstImg.setOnClickListener(this);
		
		firstImgTittle = (TextView) mainView.findViewById(R.id.b03v00G0Img7Tittle);
		...
		jiaohuanBtn = (LinearLayout) mainView.findViewById(R.id.b03v00G0Item10Btn);
