...
public class B03V00ModleView implements OnClickListener{
	...
	private void initView() {
		mainView = ((Activity)context).getLayoutInflater().inflate(R.layout.b03v00_detail_m, null);
		
		firstImg = (RelativeLayout) mainView.findViewById(R.id.b03v00G0Img0Btn);
		firstImg.setOnClickListener(this);
		firstImgTittle = (TextView) mainView.findViewById(R.id.b03v00G0Img0Tittle);
		firstImgTime = (TextView) mainView.findViewById(R.id.b03v00G0Img0Time);
		
		secondImg = (RelativeLayout) mainView.findViewById(R.id.b03v00G0Img1Btn);
		secondImg.setOnClickListener(this);
		secondImgTittle = (TextView) mainView.findViewById(R.id.b03v00G0Img1Tittle);
		...
		thirdImgTittle = (TextView) mainView.findViewById(R.id.b03v00G0Img3Tittle);
		thirdImgTime = (TextView) mainView.findViewById(R.id.b03v00G0Img3Time);
		
		fourthImg = (RelativeLayout) mainView.findViewById(R.id.b03v00G0Img4Btn);
		fourthImg.setOnClickListener(this);
		fourthImgTittle = (TextView) mainView.findViewById(R.id.b03v00G0Img4Tittle);
