...
public class CommonOverlayView {
	...
	private void initView() {
		mainView = ((Activity)context).getLayoutInflater().inflate(R.layout.common_overlay_layout, null);
		
		overlayTittle = (TextView) mainView.findViewById(R.id.commonOverlayTittle);
		
		overlayDetail = (TextView) mainView.findViewById(R.id.commonOverlayDetail);
		...
		overlayToHere = (Button) mainView.findViewById(R.id.commonOverlayToHere);
