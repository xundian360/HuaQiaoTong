...
public class CommonShearView extends BottomDialog {
	...
	private void initData() {
		...
		shearImgPath =Environment.getExternalStorageDirectory().getAbsolutePath() + "/pic.jpg";
	}
	...
	private void initView() {
		mainView = ((Activity)context).getLayoutInflater().inflate(R.layout.common_shear_layout, null);
	...
	OnClickListener weixinImgClick = new OnClickListener() {
		...
		public void onClick(View v) {
			// 分享到微信
			ShearUtil.shearPicToWxWithPath(context, "花桥测试", "测试测试测试测试测试测试", shearImgPath, paListener);
		}
	};
	...
	OnClickListener pengyouImgClick = new OnClickListener() {
		...
		public void onClick(View v) {
			// 分享到朋友圈
			ShearUtil.shearPicToWxFWithPath(context, "花桥测试", "测试测试测试测试测试测试", shearImgPath, paListener);
		}
	};
	...
	DialogInterface.OnClickListener weiboShearClick = new DialogInterface.OnClickListener() {
		...
		public void onClick(DialogInterface dialog, int which) {
			// 分享到新浪微博
			ShearUtil.shearToSinaWeibo(context, inputDialog.getMsg(), shearImgPath, paListener);
		}
	};
