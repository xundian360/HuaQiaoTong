...
public class BottonShearSelectDialog extends BottomDialog {
	...
	public BottonShearSelectDialog(Context context, String shearTittle, String shearText, String shearImgPath) {
		super(context);
	...
	private void initView() {
		...
		view = LayoutInflater.from(context).inflate(R.layout.shear_select_dialog_layout, null);
