...
public class SimpleYyMmDdSelectDialog {
	...
	public SimpleYyMmDdSelectDialog(final Context context, SimpleYyMmDdSelectCallBackInterface callback) {
	...
	private OnDateSetListener enter = new OnDateSetListener() {
		...
		public void onDateSet(DatePicker view, int year, int monthOfYear,int dayOfMonth) {
			...
			Calendar calendarTemp = new GregorianCalendar(year, monthOfYear, dayOfMonth);
			
			callback.callbackDate(StringUtils.getFormatTime1(calendarTemp.getTime()));
		}
