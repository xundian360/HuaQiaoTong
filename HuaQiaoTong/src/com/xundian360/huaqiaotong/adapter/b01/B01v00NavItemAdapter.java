...
public class B01v00NavItemAdapter extends SimpleAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		LinearLayout itemNavView = (LinearLayout) view
				.findViewById(R.id.b01v00NavItemView);
		TextView itemNavName = (TextView) view
				.findViewById(R.id.b01v00NavItemName);

		if (selectIndex == position) {
			view.setBackgroundColor(context.getResources().getColor(
					R.color.b04v05_item_supper_color));
			itemNavView.setBackgroundColor(context.getResources().getColor(
					R.color.b04v05_item_supper_color));
			itemNavName.setTextColor(Color.WHITE);
		} else {
			view.setBackgroundColor(Color.WHITE);
			itemNavView.setBackgroundColor(Color.WHITE);
			itemNavName.setTextColor(context.getResources().getColor(
