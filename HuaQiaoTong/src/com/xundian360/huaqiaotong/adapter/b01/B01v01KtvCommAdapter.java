...
public class B01v01KtvCommAdapter extends SimpleAdapter {
	...
	public static final String[] from = { "b01v00KtvCommPic",
			"b01v00KtvCommAuther", "b01v00KtvCommDatail", "b01v00KtvCommTime" };
	public static final int[] to = { R.id.b01v00KtvCommPic,
			R.id.b01v00KtvCommAuther, R.id.b01v00KtvCommDatail,
			R.id.b01v00KtvCommTime };
	...
	DisplayImageOptions options = new DisplayImageOptions.Builder()
			...
			.showImageOnFail(R.drawable.b01v00_item_pic_bg).cacheOnDisc(true)
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		ImageView userLogo = (ImageView) view
				.findViewById(R.id.b01v00KtvCommPic);
		userLogo.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View arg0) {
				// 个人页面迁移
				CommonUtil.startActivityForResult(context,
						B04V03Activity.class, B04V03Activity.USER_COMMENT_KEY,
						shopComments.get(position), 100);
			}
		});

		// 加载图片
		ImageLoader.getInstance().displayImage(shopComment.getUserLogoPath(),
				userLogo, options);

		// 设置评分
		RatingBar itemRating = (RatingBar) view
				.findViewById(R.id.b01v00KtvCommRating);
