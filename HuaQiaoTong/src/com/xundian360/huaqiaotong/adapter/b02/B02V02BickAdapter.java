...
public class B02V02BickAdapter extends SimpleAdapter {
	...
	public static final String[] from = {"b02v02ItemBickImg", "b02v02ItemBickAddress", 
		"b02v02ItemBickAllNum", "b02v02ItemBickLastNum", "b02v02ItemBickDistance"};
	
	public static final int[] to = {R.id.b02v02ItemBickImg, R.id.b02v02ItemBickAddress, 
		R.id.b02v02ItemBickAllNum, R.id.b02v02ItemBickLastNum, R.id.b02v02ItemBickDistance};
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		// 下一级菜单
		ImageView toSubArrow = (ImageView) view.findViewById(R.id.b02v02ItemArrow);
		toSubArrow.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				
				Intent in =context.getIntent();
				in.putExtra(B02V02Activity.SINGLE_RETURN_KEY, bickListData.get(position).getUid());
