...
public class B02V01TexiAdapter extends SimpleAdapter {
	...
	public static final String[] from = {"b02v01ItemName", "b02v01ItemFavorateImg", 
		"b02v01ItemFavorateNum", "b02v01ItemPlate", "b02v01ItemPhone"};
	
	public static final int[] to = {R.id.b02v01ItemName, R.id.b02v01ItemFavorateImg, 
		R.id.b02v01ItemFavorateNum, R.id.b02v01ItemPlate, R.id.b02v01ItemPhone};
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		callTxte.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				CommonUtil.callPhone(context, texiItems.get(position).getPhone());
			}
		});
