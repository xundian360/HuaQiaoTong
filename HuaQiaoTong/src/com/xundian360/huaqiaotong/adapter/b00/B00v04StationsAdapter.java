...
public class B00v04StationsAdapter extends SimpleAdapter {
	...
	public static final String from[] = {"b00v04ItemStationName", "b00v04ItemStationAddress"};
	
	public static final int to[] = {R.id.b00v04ItemStationName, R.id.b00v04ItemStationAddress};
	...
	public B00v04StationsAdapter(Context context,List<? extends Map<String, ?>> data, 
			int resource, String[] from, int[] to, List<Station> stations) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	// 取得子项目
		TextView stationBusesTittle = (TextView) view.findViewById(R.id.b00v04ItemStationAddressTittle);
		
    	TextView stationBuses = (TextView) view.findViewById(R.id.b00v04ItemStationAddress);
