...
public class B00v02StationsAdapter extends SimpleAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// Item Logo
		ImageView itemLogo = (ImageView) view.findViewById(R.id.b00v02XianluItemLogo);
        
		// 设置站点颜色
        TextView textView = (TextView) view.findViewById(R.id.b00v02XuanluItemName);
        
        // 设置到站时间
        TextView forecastTime = (TextView) view.findViewById(R.id.b00v02XuanluItemTime);
		...
		if(nextStopIds != null && !nextStopIds.isEmpty()) {
			...
			for (int i = 0; i < nextStopIds.size(); i++) {
				...
				if(stationIs.equals(netLine.getNextStopId())) {
					...
					// 当前站点即将到站
					textView.setTextColor(context.getResources().getColor(R.color.b00_v02_item_color));
					
					// 设置预计时间
					forecastTime.setVisibility(View.VISIBLE);
					
					if("0".equals(netLine.getTime())) {
						forecastTime.setText(context.getString(R.string.b00v02_forecast_text_1));
						forecastTime.setTextColor(context.getResources().getColor(R.color.b00_v02_forecast_item_color_1));
					} else {
						forecastTime.setText(context.getString(R.string.b00v02_forecast_text_0, netLine.getTime()));
						forecastTime.setTextColor(context.getResources().getColor(R.color.b00_v02_forecast_item_color_0));
					}
