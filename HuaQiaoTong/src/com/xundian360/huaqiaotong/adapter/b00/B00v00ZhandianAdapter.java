...
public class B00v00ZhandianAdapter extends SimpleAdapter {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        // 收藏按钮
        ImageView shoucangImg = (ImageView) view.findViewById(R.id.b00v00ZhandianSaveFlag);
        ...
        shoucangImg.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
		        ...
		        if(station.isSave()) {
			        ...
			        // 设值图片状态
			        ((ImageView)v).setImageResource(R.drawable.b00v02_no_shuocang_btn);
			        
			        ShowMessageUtils.show(context, R.string.msg_no_shoucang_cancel);
			        ...
			        stationDbHelper.updateStatus(station);
			        // 设值图片状态
			        ((ImageView)v).setImageResource(R.drawable.b00v02_shuocang_btn);
			        
			        ShowMessageUtils.show(context, R.string.msg_shoucang_success);
		        }
			}
		});
