...
public class B03V00NavAdapter extends SimpleExpandableListAdapter {
	...
	// Key
	public static final String[] p_from = { "b00v02NavLevel1ItemLogo",
			"b00v02NavLevel1ItemName" };
	// Key ID
	public static final int[] p_to = { R.id.b00v02NavLevel1ItemLogo,
			R.id.b00v02NavLevel1ItemName };
	...
	public static int[] nav_logo_ids = { R.drawable.b03v00_nav_new_0,
			R.drawable.b03v00_nav_fre_0, R.drawable.b03v00_nav_fang_0,
			R.drawable.b03v00_nav_rec_0, R.drawable.b03v00_nav_er_0 };
	...
	public View getGroupView(int groupPosition, boolean isExpanded,
		...
		// view.findViewById(R.id.b00v02NavLevel1ItemLogo);
		// logoView.setImageResource(nav_logo_ids[groupPosition]);
		//
		// TextView navNameView = (TextView)
		// view.findViewById(R.id.b00v02NavLevel1ItemName);
