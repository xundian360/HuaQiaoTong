...
public class B03V00PostsAdapter extends SimpleAdapter {
	...
	public static final String[] from = { "b03v00ItemTittle",
			"b03v00ItemAuthor", "b03v00ItemCommentNum" };

	public static final int[] to = { R.id.b03v00ItemTittle,
			R.id.b03v00ItemAuthor, R.id.b03v00ItemCommentNum };
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String msgText = "<!--PSTYLE=WBDY_Web bodytext--><p>"
				+ postses.get(position).gettDtail() + "</p>";

		// 设置缩略消息
		FlowTextView detailM = (FlowTextView) view
				.findViewById(R.id.b03v00ItemFlowText);
		...
		ImageLoader.getInstance().displayImage(postses.get(position).getImg(),
				itemImg);
