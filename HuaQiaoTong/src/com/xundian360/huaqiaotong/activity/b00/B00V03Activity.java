...
public class B00V03Activity extends ComNoTittleActivity {
	...
	public static final int[] to = { R.id.b00v03ZhandianBusNum,
			R.id.b00v03ZhandianBusTime, R.id.b00v03ZhandianBus1,
			R.id.b00v03ZhandianBus2 };
	...
	private void initData() {
		...
		// 设置adapter
		adapter = new B00V03StationAdapter(this, data,
				R.layout.b00v03_zhandian_item, from, to);
