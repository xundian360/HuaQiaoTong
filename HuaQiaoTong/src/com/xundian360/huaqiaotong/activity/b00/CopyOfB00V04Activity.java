 ...
 * @version 1.0
 */
public class CopyOfB00V04Activity extends ComNoTittleMapActivity {
...
//		
//		// 设置Adapter
//		listAdapter = new B00v04StationsAdapter(this, data, R.layout.b00v04_item, 
//				B00v04StationsAdapter.from, B00v04StationsAdapter.to, stations);
//	}
//	
//	// 初始化组件
...
//				
//				stationsList.startAnimation(AnimationUtils.loadAnimation(CopyOfB00V04Activity.this, R.anim.push_left_in));
//				stationsList.setVisibility(View.VISIBLE);
//				
//				mapView.startAnimation(AnimationUtils.loadAnimation(CopyOfB00V04Activity.this, R.anim.push_right_out));
...
//			} else {
//				
//				stationsList.startAnimation(AnimationUtils.loadAnimation(CopyOfB00V04Activity.this, R.anim.push_left_out));
//				stationsList.setVisibility(View.GONE);
//				
//				mapView.startAnimation(AnimationUtils.loadAnimation(CopyOfB00V04Activity.this, R.anim.push_right_in));
...
//			for (Station station : stations) {
//				
//		         GeoPoint geoPoint = new GeoPoint ((int)station.getLongitude() ,(int)station.getLatitude());
//		         
//		         Log.d("debug", "station.getLatitude() > " + station.getLatitude());
//		         
//		         OverlayItem verlayItem = new OverlayItem(geoPoint,station.getName(),"");
