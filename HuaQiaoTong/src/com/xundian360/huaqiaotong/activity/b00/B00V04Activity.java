	...
	OnClickListener mapOrListBtnClick = new OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			if(stationsList.getVisibility() == View.GONE) {
				...
				stationsList.startAnimation(AnimationUtils.loadAnimation(B00V04Activity.this, R.anim.push_left_in));
				stationsList.setVisibility(View.VISIBLE);
				
				mapView.startAnimation(AnimationUtils.loadAnimation(B00V04Activity.this, R.anim.push_right_out));
				...
				stationsList.startAnimation(AnimationUtils.loadAnimation(B00V04Activity.this, R.anim.push_left_out));
				stationsList.setVisibility(View.GONE);
				
				mapView.startAnimation(AnimationUtils.loadAnimation(B00V04Activity.this, R.anim.push_right_in));
