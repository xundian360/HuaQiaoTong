 ...
 * @version  1.0
 */
public class CopyOfB00V01Activity extends ComNoTittleActivity {
...
//			busDate.put(from[0], station.getName() + "  " + station.getDirection());
//			
...
//				
//				// 切换按钮
//				shouCangSwitch.setImageResource(R.drawable.b00v01_xianglu_select);
//				
//				// 设置显隐形
...
//				
//				// 切换按钮
//				shouCangSwitch.setImageResource(R.drawable.b00v01_zhangdian_select);
//				
//				// 设置显隐形
...
//				long arg3) {
//			
//			Intent in = new Intent(CopyOfB00V01Activity.this, B00V03Activity.class);
//			
//			in.putExtra(B00V03Activity.STATION_KEY, zhandianBus.get(arg2));
//			
//			CommonUtil.startActivityForResult(CopyOfB00V01Activity.this, in, START_RESULT_CODE);
//		}
//	};
//	
//	/**
...
//				long arg3) {
//			
//			Intent in = new Intent(CopyOfB00V01Activity.this, B00V02Activity.class);
//			
