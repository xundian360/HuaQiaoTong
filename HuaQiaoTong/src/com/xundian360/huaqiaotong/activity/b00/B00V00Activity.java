...
public class B00V00Activity extends ComNoTittleBMapManActivity {
	...
	private void setOtherData() {
		...
		if (in != null) {
			...
			goHereObj = (Baidu) in
					.getSerializableExtra(B01V01Activity.GO_HERE_KEY);
	 ...
	 *            添加的视图
	 */
	private void switchViewWithAn(int startIndex, int endIndex, View view1,
			View view2) {

		if (startIndex > endIndex) {
			view1.startAnimation(AnimationUtils.loadAnimation(this,
					R.anim.push_right_out));
			view2.startAnimation(AnimationUtils.loadAnimation(this,
					R.anim.push_left_in));
		}
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		if (resultCode == B00V04Activity.STATION_SELECT_RESULT_CODE) {
			...
			Station selectStation = (Station) data
					.getSerializableExtra(B00V04Activity.RESULT_STATION_KEY);
