 ...
 * @version 1.0
 */
public class CopyOfB00V05Activity extends ComNoTittleBMapManActivity {
...
//				ShowMessageUtils.show(CopyOfB00V05Activity.this, R.string.b00v05_no_other_fangan_text);
//			}
//			
//			// 显示Dialog
...
//				Toast.makeText(CopyOfB00V05Activity.this, "抱歉，未找到结果",Toast.LENGTH_LONG).show();
//				return ;
//			}
//			else if (iError != 0 || result == null) {
//				Toast.makeText(CopyOfB00V05Activity.this, "搜索出错啦..", Toast.LENGTH_LONG).show();
//				return;
//			}
//			
//			// 设置换乘
