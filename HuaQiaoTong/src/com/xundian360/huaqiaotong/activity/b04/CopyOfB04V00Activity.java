 ...
 * @version 1.0
 */
public class CopyOfB04V00Activity extends ComNoTittleActivity implements PlatformActionListener, Callback {
...
//		loginOtherBtn.setOnClickListener(loginOtherBtnClick);
	...
	OnClickListener signBtnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			CommonUtil.startActivityForResult(CopyOfB04V00Activity.this, B04V01Activity.class, 100);
		}
	};
	...
	OnClickListener loginOtherBtnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			ShowMessageUtils.show(CopyOfB04V00Activity.this, "其他方式登录");
			
			// 非空
			if(loginSelectDialog == null) {
				loginSelectDialog = new SimpleListDialog(CopyOfB04V00Activity.this, 
						onLoginSelect, 
						loginWayTittle, 
						loginWay);
			}
	...
	DialogInterface.OnClickListener onLoginSelect = new DialogInterface.OnClickListener() {
		...
		public void onClick(DialogInterface dialog, int which) {
			...
			if (pingtai != null) {
				//初始化平台
				Platform pf = ShareSDK.getPlatform(CopyOfB04V00Activity.this, pingtai);
				//设置监听
				pf.setPlatformActionListener(CopyOfB04V00Activity.this);
	...
	private void login() {
    	...
    	// 判断是否登录成功
    		...
    		// 个人中心
    		CommonUtil.startActivityForResult(CopyOfB04V00Activity.this, B04V03Activity.class, 100);
    	} else {
	...
	public boolean handleMessage(Message msg) {
		...
		case MSG_TOAST: {
			...
			Toast.makeText(CopyOfB04V00Activity.this, text, Toast.LENGTH_SHORT).show();
		}
		break;
		case MSG_ACTION_CCALLBACK: {
			switch (msg.arg1) {
				case 1: { // 成功
					ShowMessageUtils.show(CopyOfB04V00Activity.this, "授权成功");

					//授权成功后,获取用户信息，要自己解析，看看oncomplete里面的注释
					//ShareSDK只保存以下这几个通用值
					Platform pf = ShareSDK.getPlatform(CopyOfB04V00Activity.this, SinaWeibo.NAME);
				...
				case 2: { // 失败
					...
					if ("WechatClientNotExistException".equals(expName)
						...
						ShowMessageUtils.show(CopyOfB04V00Activity.this, getString(R.string.wechat_client_inavailable));
					}
					else if ("GooglePlusClientNotExistException".equals(expName)) {
						ShowMessageUtils.show(CopyOfB04V00Activity.this, getString(R.string.google_plus_client_inavailable));
					}
					else if ("QQClientNotExistException".equals(expName)) {
						ShowMessageUtils.show(CopyOfB04V00Activity.this, getString(R.string.qq_client_inavailable));
					}
					else {
						ShowMessageUtils.show(CopyOfB04V00Activity.this, "授权失败");
					}
				}
				break;
				case 3: { // 取消
					ShowMessageUtils.show(CopyOfB04V00Activity.this, "取消授权");
				}
				break;
			}
		}
