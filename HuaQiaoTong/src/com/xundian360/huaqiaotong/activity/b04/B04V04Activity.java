...
public class B04V04Activity extends ComNoTittleActivity {
	...
	private void initModule() {
		...
		ImageLoader.getInstance().displayImage(
				userModle.user.getLogoPath().replace(UserUtils.USER_ICON_200,
						UserUtils.USER_ICON_100), userLogo, options);
	...
	private void updateUserRun() {
		...
		if (picSelectDialog != null
				&& new File(picSelectDialog.cutImgPath).exists()) {
			fileKeys.add("img");
			filePaths.add(picSelectDialog.cutImgPath);
		}

		BaseHttpClient.doPostRequestWithFile(url, params, fileKeys, filePaths,
				callBack);
	};
	...
	RequestCallBack<String> callBack = new RequestCallBack<String>() {
		...
		public void onSuccess(ResponseInfo<String> arg0) {
			...
			if (user != null) {
				...
				ShowMessageUtils.show(B04V04Activity.this,
						R.string.b04v04_update_success_text);
		...
		public void onFailure(HttpException arg0, String arg1) {
			ShowMessageUtils.show(B04V04Activity.this,
					R.string.b04v04_update_error_text);
