 ...
 * @version 1.0
 */
public class B03V00Activity extends ComNoTittleActivity implements
		OnClickListener {
	...
	LinearLayout.LayoutParams matchP = new LinearLayout.LayoutParams(
	...
	private void swichView(int switchToIndex) {
		...
		// mainLayout.setOutAnimation(B03V00Activity.this,
		...
		case SHOW_L_KEY:
			...
			// 设置字体颜色
			lText.setTextColor(getResources().getColor(
					R.color.b03_v01_group_tittle_color_1));
			mText.setTextColor(getResources().getColor(
					R.color.b03_v01_group_tittle_color_0));
			rText.setTextColor(getResources().getColor(
					R.color.b03_v01_group_tittle_color_0));
