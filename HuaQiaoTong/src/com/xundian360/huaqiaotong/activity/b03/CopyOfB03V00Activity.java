...
public class CopyOfB03V00Activity extends CustomAnimation {
	...
	private void initData(){
		...
		adapter = new B03V00PostsAdapter(this, 
				data, 
				R.layout.b03v00_item, 
				B03V00PostsAdapter.from, 
				B03V00PostsAdapter.to, 
				postses);
...
//				B03V00NavAdapter.p_to);
		...
		navListAdapter = new B03V00NavAdapter(this, 
				navListData, 
				R.layout.b00v02_xianlu_item, 
				B03V00NavAdapter.p_from, 
				B03V00NavAdapter.p_to,
				navListChildData,
				R.layout.b03v00_nav_level2_item, 
				B03V00NavAdapter.from, 
				B03V00NavAdapter.to);
	}
	...
	OnClickListener loginNameClick = new OnClickListener() {
		...
		public void onClick(View v) {
			CommonUtil.startActivityForResult(CopyOfB03V00Activity.this, B04V00Activity.class, 100);
		}
	};
	...
	OnClickListener selfCenterClick = new OnClickListener() {
		...
		public void onClick(View v) {
			// 判断是否登陆
		    if (StringUtils.isNotBlank(userModle.user.getLoginName())) {
		    	CommonUtil.startActivityForResult(CopyOfB03V00Activity.this, B04V03Activity.class, 100);
			} else {
				CommonUtil.startActivityForResult(CopyOfB03V00Activity.this, B04V00Activity.class, 100);
			}
		}
	...
	OnItemClickListener talkListItemClick = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			CommonUtil.startActivityForResult(CopyOfB03V00Activity.this, B03V02Activity.class, 100);
		}
	};
	...
	private void setNavLevel2Adapter() {
		...
		for (int i = 0; i < B03V00NavAdapter.level2Ids.length; i++) {
			...
			String[] childItemNames = getResources().getStringArray(B03V00NavAdapter.level2Ids[2]);
	...
	private void setTopViewFilterData() {
		...
		for (int i = 0; i < 5; i++) {
			...
			// 设置ViewFilter
			View topItemView = getLayoutInflater().inflate(R.layout.b03v00_top_item, null);
			
			ImageView topItemImg = (ImageView) topItemView.findViewById(R.id.b03v00TompItemImg);
			topItemImg.setBackgroundResource(R.drawable.test_img_2);
			
			TextView topItemName = (TextView) topItemView.findViewById(R.id.b03v00TompItemName);
...
//			itemParams.weight = 1;
	...
	private void changeProcess(int index) {
		...
		for (int i = 0; i < topViewsProcess.getChildCount(); i++) {
			...
			ImageView topItemProcess = (ImageView) topViewsProcess.getChildAt(i);
