...
public class B02V03Activity extends ComNoTittleActivity {
	...
	private void initData(){
		...
		bickListData = (ArrayList<Bick>) getIntent().getSerializableExtra(B02V03ACTIVITY_BICKLIST);
		...
		// 初始化数据源
		bickAdapter = new B02V02BickAdapter(this, bickData, R.layout.b02v02_item, 
				B02V02BickAdapter.from, B02V02BickAdapter.to, bickListData);
	}
	...
	private void setAdapterData(){
		...
		for (Serializable bickItem : bickListData) {
			...
			bickItemMap.put(B02V02BickAdapter.from[0], R.drawable.b02v02_have_bick_img);
			...
			bickItemMap.put(B02V02BickAdapter.from[4], 
					StringUtils.formatDoubleToString(bick.getRelaDistance() / 1000));
