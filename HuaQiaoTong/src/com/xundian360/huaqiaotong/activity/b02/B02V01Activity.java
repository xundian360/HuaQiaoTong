...
public class B02V01Activity extends ComNoTittleActivity {
	...
	private void initData() {
		...
		// 初始化数据源
		texiAdapter = new B02V01TexiAdapter(this, texiData,
				R.layout.b02v01_item, B02V01TexiAdapter.from,
				B02V01TexiAdapter.to, texiItems);
	...
	private void setAdapterData() {
		...
		for (Texi texiItem : texiItems) {
			...
			texiItemMap.put(B02V01TexiAdapter.from[1],
					R.drawable.common_favorate_img_0);
			texiItemMap.put(B02V01TexiAdapter.from[2],
					texiItem.getFavorateNum());
			texiItemMap.put(B02V01TexiAdapter.from[3], texiItem.getPlate());
			texiItemMap.put(B02V01TexiAdapter.from[4],
					getString(R.string.b02v01_call_text));
	...
	private void setTexiData() {
		for (int i = 0; i < 10; i++) {
			Texi texiItem = new Texi("万师傅", "上海大众", "苏E12345", "15000654736",
					"+152");
