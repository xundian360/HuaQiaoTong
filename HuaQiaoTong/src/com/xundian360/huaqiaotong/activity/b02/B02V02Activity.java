    ...
    PopupClickListener popListener = new PopupClickListener(){
		...
		public void onClickedPopup(int index) {
			if ( index == 0){
				//更新item位置
			      pop.hidePop();
//			      GeoPoint p = new GeoPoint(mOverlay.mCurItem.getPoint().getLatitudeE6()+5000,
...
//			      mapView.refresh();
				...
				//更新图标
				mOverlay.mCurItem.setMarker(getResources().getDrawable(R.drawable.b02v02_bick_gcoding_1));
				mOverlay.updateItem(mOverlay.mCurItem);
			    mapView.refresh();
			}
		}
	...
	OnClickListener toListBtnClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			if(bickList != null && bickList.size() > 0) {
				...
				// 跳转到列表模式
				Intent intent = new Intent(B02V02Activity.this,  B02V03Activity.class);
				
				intent.putExtra(B02V03Activity.B02V03ACTIVITY_BICKLIST, bickList);
				intent.putExtra(B02V03Activity.B02V03ACTIVITY_MY_LAT, myLocation.latitude);
				intent.putExtra(B02V03Activity.B02V03ACTIVITY_MY_LON, myLocation.longitude);
				
				CommonUtil.startActivityForResult(B02V02Activity.this, intent, SINGLE_REQUEST_CODE);
		...
		public void run() {
			...
			if(bickList != null && !bickList.isEmpty()) {
				...
				mOverlay = new BickItemOverlay(B02V02Activity.this,
								getResources().getDrawable(R.drawable.b02v02_bick_gcoding),
								mapView, bickList);
				...
				for (Serializable carPoint : bickList) {
					...
					Baidu baiduCatPoint = (Baidu)carPoint;
			         ...
			         verlayItem.setMarker(getResources().getDrawable(R.drawable.b02v02_bick_gcoding));
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		// 自行车站点点击
		if(SINGLE_REQUEST_CODE == requestCode && SINGLE_RETURN_CODE == resultCode) {
	...
	public void showBottomDialog(Bick bickItem) {
		...
		// 覆层View
//		BickItemBottomDialog bickView = new BickItemBottomDialog(this, bickItem);
//		bickView.show();
