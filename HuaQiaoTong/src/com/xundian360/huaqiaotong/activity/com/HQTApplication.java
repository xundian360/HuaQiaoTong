...
public class HQTApplication extends Application {
	...
	public void initEngineManager(Context context) {
        ...
        if (!mBMapManager.init(getString(R.string.baidu_map_key), 
            ...
            Toast.makeText(HQTApplication.getInstance().getApplicationContext(), 
    ...
    static class MyGeneralListener implements MKGeneralListener {
        ...
        public void onGetNetworkState(int iError) {
            if (iError == MKEvent.ERROR_NETWORK_CONNECT) {
                Toast.makeText(HQTApplication.getInstance().getApplicationContext(), "您的网络出错啦！",
                    Toast.LENGTH_LONG).show();
            }
            else if (iError == MKEvent.ERROR_NETWORK_DATA) {
                Toast.makeText(HQTApplication.getInstance().getApplicationContext(), "输入正确的检索条件！",
                        Toast.LENGTH_LONG).show();
            }
        }
