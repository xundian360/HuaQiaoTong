 ...
 * @version 1.0
 */
public class CopyOfB01V03Activity extends ComNoTittleActivity {
...
//		impMsg.requestFocus();
	...
	OnClickListener okBtnClick = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			ShowMessageUtils.show(CopyOfB01V03Activity.this, "提交成功！");
		}
	};
	...
	OnClickListener impGoodClick = new OnClickListener() {
		...
		public void onClick(View v) {
			//打开键盘
			CommonUtil.showInput(CopyOfB01V03Activity.this);
			ShowMessageUtils.show(CopyOfB01V03Activity.this, "评价：满意");
		}
	};
	...
	OnClickListener impOkClick = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			ShowMessageUtils.show(CopyOfB01V03Activity.this, "评价：一般");
		}
	};
	...
	OnClickListener impNgClick = new OnClickListener() {
		...
		@Override
		public void onClick(View v) {
			ShowMessageUtils.show(CopyOfB01V03Activity.this, "评价：不满意");
		}
	};
}
